...
--
-- Host: localhost:3306
-- Generation Time: Oct 22, 2025 at 05:49 PM
...
('0123456789', 'administrator', 'test', '0');
...
CREATE TABLE `invoice` (
  ...
  `Service_location` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `time_sell` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `name_product` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `price_product` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `Volume` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
('b99c6c3d', '0123456789', '0123456789_abd3', 'test', '1761148274', 'test', '45000', '30', '30', NULL, 'active', NULL, '{\"volume\":false,\"time\":false}', '1761151923', '0', NULL, NULL);
...
('botstatuson', 'rolleon', 'onAuthenticationphone', 'onAuthenticationiran', 'onnotuser', NULL, '1', 'onaffiliates', '0', '0', '1', '0', 'onnewuser', 'onrequestagent', 'offcategory', NULL, '2', 'offinline', 'offverify', 'tlgrmv2', 'onnamecustom', 'offcategorys', 'offpvsupport', '0', 'onbulk', '4', '5', 'onverify', '1', '{\"one\":\"0\",\"tow\":\"0\",\"theree\":\"0\"}', '1', '0', NULL, '2', '1', '1', '62.60.217.66', '1', '1', '0', '0', '1', '1', '1', '1', '{\"keyboard\":[[{\"text\":\"text_sell\"},{\"text\":\"text_extend\"}],[{\"text\":\"text_usertest\"},{\"text\":\"text_wheel_luck\"}],[{\"text\":\"text_Purchased_services\"},{\"text\":\"accountwallet\"}],[{\"text\":\"text_affiliates\"},{\"text\":\"text_Tariff_list\"}],[{\"text\":\"text_support\"},{\"text\":\"text_help\"}]]}', '1', '1', '4', '1', '{\"day\":true,\"volume\":true,\"remove\":true,\"remove_volume\":true,\"test\":true,\"on_hold\":true,\"uptime_node\":true,\"uptime_panel\":true}', '{\"free\":100,\"all\":100}');
...
CREATE TABLE `user` (
  `id` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `ref_code` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  ...
  `description_blocking` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `number` varchar(2000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `Balance` int NOT NULL,
  `User_Status` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `pagenumber` int NOT NULL,
  `message_count` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `last_message_time` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `affiliatescount` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `affiliates` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `verify` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `username` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `token` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `status_cron` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `expire` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `limitchangeloc` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `bottype` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `score` int DEFAULT NULL,
  `checkstatus` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `joinchannel` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `maxbuyagent` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `agent` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `register` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `namecustom` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `number_username` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `cardpayment` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `codeInvitation` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
  `pricediscount` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
